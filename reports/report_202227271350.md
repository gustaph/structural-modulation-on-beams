...
---
<p align="center"><img src=../plots/beam/plot_202227271350.jpg width=90%/></p> 
...
> $$M(x \longrightarrow L) = ? \qquad \qquad V(x \longrightarrow L) = 0.0$$
...
$$\Rightarrow \frac{d^{2}}{d x^{2}} M{\left(x \right)} = - 3 {\left\langle x \right\rangle}^{0}$$
...
---
$\boxed{ x \longrightarrow 0.0 } $
> $$V(x \longrightarrow 0.0) = 0.0$$
$$V{\left(0.0 \right)} = C_{1} - 0.0 \cdot 3 = 0.0$$
$$C_{1} = 0.0$$
$$\boxed{ C_{1} = 0 } $$
$\boxed{ x \longrightarrow L } $
> $$M(x \longrightarrow L) = 0.0$$
$$M{\left(4.0 \right)} = C_{2} - \frac{3 \cdot 4.0^{2}}{2} + 0 \cdot 4.0 = 0.0$$
$$C_{2} - 24.0 = 0.0$$
$$\boxed{ C_{2} = 24.0 } $$
## **4. Model plot**
$$\boxed{ M{\left(x \right)} = 24.0 - \frac{3 x^{2}}{2}; \qquad V{\left(x \right)} = - 3 x } $$
<p align="center"><img src=../plots/strain/plot_202227271350.jpg width=100%/></p> 
